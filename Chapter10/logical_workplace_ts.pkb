...
ain_id                         in     LOGICAL_WORKPLACE_T.id%TYPE,
aid_inactive_date              in     LOGICAL_WORKPLACE_T.inactive_date%TYPE) is
...
begin
  TEXT_HELP.process('LOGICAL_WORKPLACE_TS');
end help;
...
--    r_logical_workplace.id := NULL;
  ...
  TEST_TS.set_test('LOGICAL_WORKPLACE_TS', 'is_duplicate()', 11, 
  ...
  TEST_TS.set_test('LOGICAL_WORKPLACE_TS', 'DELETE', 12, 
    'Delete test entries');
  begin
    delete LOGICAL_WORKPLACE_T
    where  code in (
